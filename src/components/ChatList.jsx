                ...
                {isUser ? (
                  ...
                  <div className="flex justify-start">
                    <div className="relative w-full max-w-[94%]">
                      ...
                      <div className="mt-2.5 min-h-3 flex flex-wrap items-center gap-x-3 gap-y-1 px-1 text-[10px] text-white/25">
                        {aiRequest ? (
                          <>
                            ...
                            <span>
                              Thinking {aiRequest.thinkingTokens ?? 0}
                            </span>
                      ...
                      {index == activeMessages.length - 1 && reworkUI && (
                        <div className="flex items-center justify-end flex-1 z-50 over">
                          <button
                            type="button"
