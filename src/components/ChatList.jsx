          ...
          <Fragment key={index}>
            ...
            {prompt.role === "ASSISTANT" &&
              activeMessages[index - 1]?.aiRequest && (
                <div className="ml-4 -mt-2 flex w-full gap-4 text-xs text-neutral-500">
                  <span>
                    Input: {activeMessages[index - 1].aiRequest.inputTokens}
                  </span>

                  <span>
                    Output: {activeMessages[index - 1].aiRequest.outputTokens}
                  </span>

                  <span>
                    Thinking:{" "}
                    {activeMessages[index - 1].aiRequest.thinkingTokens}
                  </span>

                  <span>
                    Total: {activeMessages[index - 1].aiRequest.totalTokens}
                  </span>
                </div>
              )}
          </Fragment>
